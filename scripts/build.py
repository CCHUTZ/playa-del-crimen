...
SCENARIOS = [
    {
        ...
        'number': '00',
        'tagline': 'Inteligencia sociotécnica y mapeo de redes informales de poder.',
        'category': 'OSINT · Ingeniería Social · Threat Intel',
    },
    {
        'id': '01_operacion_krakatoa',
        'title': 'Operación Krakatoa',
        'number': '01',
        'tagline': 'Análisis de ecosistemas corporativos y riesgo reputacional en conflictos ambientales.',
        'category': 'OSINT · Riesgo Corporativo · Geopolítica',
    },
    {
        'id': '02_la_cloaca',
        'title': 'La Cloaca',
        'number': '02',
        'tagline': 'Rastreo de flujos de recursos públicos y exposición de redes de corrupción municipal.',
        'category': 'OSINT · Inteligencia Política · Finanzas',
    },
    {
        'id': '03_castillos_de_arena',
        'title': 'Castillos de Arena',
        'number': '03',
        'tagline': 'Rastreo de identidad digital y perfilamiento conductual en fraude inmobiliario.',
        'category': 'OSINT · Fraude · Identidad Digital',
    },
    {
        'id': '04_el_tren_fantasma',
        'title': 'El Tren Fantasma',
        'number': '04',
        'tagline': 'Análisis de campañas de manipulación informacional y redes de desinformación.',
        'category': 'OSINT · Desinformación · Análisis de Redes',
    },
    {
        'id': '05_por_la_puerta_de_atras_uwu',
        'title': 'Por la puerta de atrás uwu',
        'number': '05',
        'tagline': 'Rastreo de infraestructura de carding, smishing y fraude financiero a gran escala.',
        'category': 'Carding · Fraude Financiero · Smishing',
    }
]
...
<head>
    ...
    <title>Escenario {number}: {title} | Playa del Crimen</title>
...
<body class="page-scenario">
    ...
    <header>
        <div class="header-inner">
            ...
            <nav class="header-nav">
                <a href="../index.html">← Escenarios</a>
                <a href="https://github.com/CCHUTZ/playa-del-crimen" target="_blank" rel="noopener">GitHub ↗</a>
            </nav>

            <div class="header-status">
                <span class="status-dot"></span>
                <span class="mono">ESCENARIO {number}: {title_upper}</span>
            </div>
    ...
    <!-- ===== SIDEBAR ===== -->
    <aside class="sidebar">
        <p class="sidebar-label">Fases de la Operación</p>
        <ul class="sidebar-nav">
{sidebar_items}
        </ul>
        <div class="sidebar-divider"></div>
        <ul class="sidebar-nav">
            <li><a href="../index.html"><span class="nav-icon">←</span> Volver al Inicio</a></li>
        </ul>
    </aside>
    ...
    <div class="scenario-content">
        ...
        <div class="scenario-hero">
            <div class="scenario-meta">
                <span class="scenario-number">ESCENARIO {number}</span>
        ...
        <details class="mobile-nav-toggle">
            <summary>Fases de la Operación</summary>
            <ul class="sidebar-nav">
{sidebar_items}
            </ul>
        </details>
...
{content}
        ...
        <footer>
            <div class="footer-inner">
                <span class="footer-disclaimer">PLAYA DEL CRIMEN // SIMULACIÓN EDUCATIVA // ESCENARIOS FICTICIOS // SOLO PARA FINES FORMATIVOS</span>
                <a href="../index.html" class="footer-back">← Volver al Inicio</a>
            </div>
        </footer>
...
def build_sidebar_items(scenario_id):
    ...
    items.append({'anchor': 'team', 'label': 'Estructura del Equipo', 'icon': '◈'})
    ...
    if exercises_dir.exists():
        items.append({'anchor': 'exercises', 'label': 'Ejercicios', 'icon': '◈'})

    # References
    references_file = scenario_dir / "references.md"
    if references_file.exists():
        items.append({'anchor': 'references', 'label': 'Referencias', 'icon': '◈'})
